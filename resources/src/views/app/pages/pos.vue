                            ...
                            <tbody>
                              ...
                              >
                                    ...
                                    <b-input-group>
                                      <b-input-group-prepend>
                                        <span
                                          ...
                                          @click="
                                            decrement(detail, detail.detail_id)
                                          "
                                          >-</span
                                        >
                                      </b-input-group-prepend>
                                ...
                                <td>
                                  <a
                                    @click="
                                      delete_Product_Detail(detail.detail_id)
                                    "
                                    title="Delete"
                                  >
                                    <i
                    ...
                    >
                      ...
                      >
                        <span class="badge badge-info"
                          >{{ formatNumber(product.qte_sale, 2) }}
          ...
          <div id="invoice-POS">
            <div style="max-width: 500px; margin: 0px auto">
              ...
              <div id="legalcopy" class="ml-2">
                ...
                <p class="legal-note">
                  <strong
                    >*Goods once sold are neither refundable nor
                    exchangeable</strong
                  >
                </p>
                    ...
                    <b-col lg="12" md="12" sm="12">
                      ...
                      >
                        <b-form-group :label="$t('Received_Amount')">
                          <b-form-input
                            @keyup="
                              Verified_Received_Amount(payment.received_amount)
                            "
          ...
          if (product_filter.length === 1) {
            ...
            this.product_filter = this.products_pos.filter((product) => {
              return (
                product.name
                  .toLowerCase()
                  .startsWith(this.search_input.toLowerCase()) ||
                product.code
                  .toLowerCase()
                  .startsWith(this.search_input.toLowerCase()) ||
                product.barcode
