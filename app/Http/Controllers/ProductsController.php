...
class ProductsController extends BaseController
{
    ...
    {
        $data = [];
        $product_warehouse_data = product_warehouse::with('warehouse', 'product', 'product.brand', 'productVariant')
        ...
        foreach ($product_warehouse_data as $product_warehouse) {
            ...
            if ($product_warehouse['product']['brand']) {
                $item['brand'] = $product_warehouse['product']['brand']->name;
            }
